const context = `<p class='zj_content'>二十三年戊寅，公元前四零三年
...
　　太史公曰：魏惠王之所以身不死，国不分者，二国之谋不和也。若从一家之谋，魏必分矣。故曰：“君终，无適子，其国可破也。“</p>`;

const title = `<h3 class='zj_title'>周纪·周纪一</h3>`

let boxEle = document.querySelector('.box')

boxEle.innerHTML = title + context
